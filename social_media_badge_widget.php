...
function enqueue_scripts() {
    ...
    /* Load custom scripts */
    wp_enqueue_script('jquery-load', plugins_url('social_media_badge_widget/js/jquery-load.js'), array('jquery-ui-accordion')); 

    /* Load custom styling */
    wp_enqueue_style('jquery-style', plugins_url('social_media_badge_widget/css/jquery-ui-1.8.21.social-media-badge-widget.css'));
    wp_enqueue_style('widget-style', plugins_url('social_media_badge_widget/css/style.css'), array('jquery-style')); 
}    
add_action('wp_enqueue_scripts', 'enqueue_scripts');

class Social_Media_Badges_Widget extends WP_Widget {
    function Social_Media_Badges_Widget() {
            /* Widget settings. */
...
add_action( 'widgets_init', create_function('', 'return register_widget("Social_Media_Badges_Widget");'));
?>
