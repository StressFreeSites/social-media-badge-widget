    ...
    <div class="wrap">
        ...
        <div id="smbw-footer">
            ...
            <div class="box">
                ...
                <div class="left-side">
                    <a href="https://github.com/StressFreeSites/social-media-badge-widget" target="_blank"><img src="<?php echo(plugins_url('social-media-badge-widget/images/github.png')); ?>" /></a>
                </div>
                <div class="right-side">
